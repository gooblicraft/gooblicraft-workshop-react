...
const SlabBlock = ({ availableTextures = [], onAddBlock, onFormChange }) => {
  ...
  const generateBlockJson = () => {
    ...
    const name = blockData.blockName || 'slab_block';
    const group = blockData.blockGroup || 'slab';
    const displayName = blockData.blockDisplayName || 'Slab Block';
        ...
        "permutations": [
          ...
          },
          {
            ...
            "components": {
              ...
              "minecraft:custom_components": ["kai:on_player_destroy"]
            }
          }
        ],
        "components": {
  ...
  const copyToClipboard = () => {
    ...
    alert("Slab Block JSON copied to clipboard!");
  };
      ...
      <div className="workspace-shell">
        ...
        <div className="workspace-hero" style={{ textAlign: 'center', paddingBottom: '5px', paddingTop: '0px' }}>
          <div>
            ...
            <h2 className="workspace-title">Slab Block Generator</h2>
          </div>
        </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '24px' }}>
                ...
                <label className="workspace-label" style={labelStyle}>
                  ...
                  <input 
                    ...
                    placeholder="slab_block" 
                  />
                </label>

                <label className="workspace-label" style={labelStyle}>
                  <span style={{ marginBottom: '8px' }}>Display Name:</span>
                  <input type='text' className="workspace-input" style={{ width: '100%' }} value={blockData.blockDisplayName} onChange={(e) => handleUpdate('blockDisplayName', e.target.value)} placeholder="Slab Block" />
                </label>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px', marginBottom: '24px', maxWidth: '400px', margin: '0 auto 24px auto' }}>
                <label className="workspace-label" style={labelStyle}>
                  ...
                  <input 
                    ...
                    onChange={(e) => {
                      const formattedValue = e.target.value.replace(/\s+/g, '_'); 
                      handleUpdate('blockGroup', formattedValue);
                    }} 
                    placeholder="slab" 
                  />
                </label>
