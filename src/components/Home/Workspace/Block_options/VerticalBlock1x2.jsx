...
const VerticalBlock1x2 = ({ availableTextures = [], onAddBlock, onFormChange }) => {
  ...
  const generateBlockJson = () => {
    ...
    const name = blockData.blockName || 'custom_1by2_block';
    const displayName = blockData.blockDisplayName || 'Custom 1x2 Vertical Block';
      ...
      "minecraft:block": {
        ...
        "components": {
          ...
          "minecraft:geometry": {
            ...
            "bone_visibility": {
              "top": "q.block_state('goobli:block_states') == 'top'",
              "bottom": "q.block_state('goobli:block_states') == 'bottom'"
            }
          },
  ...
  const copyToClipboard = () => {
    ...
    alert("1x2 Vertical Block JSON copied to clipboard!");
  };
      ...
      <div className="workspace-shell">
        ...
        <div className="workspace-hero" style={{ textAlign: 'center', paddingBottom: '5px', paddingTop: '0px' }}>
          <div>
            ...
            <h2 className="workspace-title">1x2 Vertical Block Generator</h2>
          </div>
        </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '24px' }}>
                ...
                <label className="workspace-label" style={labelStyle}>
                  ...
                  <input 
                    ...
                    placeholder="vertical_block_1x2" 
                />                
                </label>

                <label className="workspace-label" style={labelStyle}>
                  <span style={{ marginBottom: '8px' }}>Display Name:</span>
                  <input type='text' className="workspace-input" style={{ width: '100%' }} value={blockData.blockDisplayName} onChange={(e) => handleUpdate('blockDisplayName', e.target.value)} placeholder="Custom 1x2 Vertical Block" />
                </label>
              </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
                  <label className="workspace-label" style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                    ...
                    <textarea 
                      ...
                      placeholder='[{"origin": [-8, 0, 6], "size": [16, 16, 2]}]'
                    />
                  </label>
...
export default VerticalBlock1x2;